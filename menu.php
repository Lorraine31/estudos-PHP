<nav class="modulos">
          ...
          <div class="modulo azul">
            ...
            <li><a href="exercicio.php?dir=api&file=escrever_arquivos">Escrever Arquivos</a></li>
            ...
            <li><a href="exercicio.php?dir=api&file=imagens">Desafio Imagens</a></li>
            </ul>
          </div>
          ...
          <div class="modulo verde">
            ...
            <li><a href="exercicio.php?dir=tratamento_erro&file=erros_personalisados">Erros Personalisados</a></li>
          ...
          <div class="modulo laranja-escuro">
            <h3>10. Namespace</h3>
            <ul>
            <li><a href="exercicio.php?dir=namespace&file=basico">Ex. Básico</a></li>
        ...
        <div class="modulo vermelho-escuro">
            ...
            <li><a href="exercicio.php?dir=funcoes&file=argumentos_retorno">Args & Retorno</a></li>
            <li><a href="exercicio.php?dir=funcoes&file=des_palindromo">Desafio Palindromo</a></li>
            <li><a href="exercicio.php?dir=funcoes&file=args_variaveis">Args Variáveis</a></li>
        ...
        <div class="modulo laranja">
            ...
            <li><a href="exercicio.php?dir=array&file=comparacao">Comparação entre Arrays</a></li>
            </ul>
          </div>
          ...
          <div class="modulo azul">
            ...
            <ul>
              ...
              <li><a href="exercicio.php?dir=variaveis&file=valor_referencia">Valor rs Referencia</a></li>
          ...
          <div class="modulo vermelho">
            ...
            <li><a href="exercicio.php?dir=tipos&file=booleano">Tipo Boleano</a></li>
